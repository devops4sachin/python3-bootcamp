...
class Card:
	def __init__(self, value, suit): # value, suit : 10 of hearts, A of hearts
		self.value = value
		self.suit = suit
		# c = Card("A", "Hearts")
...
class Deck:
	...
	def deal_card(self):
		return self._deal(1)[0]		# [0] will give us a card, instead of list.

	def deal_hand(self, hand_size):
		return self._deal(hand_size)	# Here we need list and not a single card.
